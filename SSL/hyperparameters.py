# -*- coding: utf-8 -*-
"""SSL_domain_generalization.ipynb

Automatically generated by Colaboratory.

Original file is located at
    https://colab.research.google.com/drive/1bteWtiofqV4E_GeQ9A6G4jGeDj1tW4sb

# Hyperparameters Setup

## Github repository cloning
Loading all the packages and updating possible dependencies to avoid problems
"""
...
# !mv Mitochondria-StyleTransfer-main/* SelfSupervisedLearning/
# !rm -R Mitochondria-StyleTransfer-main
# !rm main.zip
# !pip install -r SelfSupervisedLearning/requirements.txt

# !mkdir /content/drive/MyDrive/DA/PruebasJulio

"""## Data Sets download
To try to speed-up the loading of the images rather than loading them from the directories of Drive they are moved to the `content` folder. 
